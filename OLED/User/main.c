...
int main(void)
{
	...
	while(1)
	{
		if(Pit_flag == 1)
		{
			...
			OLED_P6x8Flo(0, 5, -12222.22, -0);
			OLED_P6x8Flo(0, 6, 122222.22, 0);
			OLED_P6x8Int(64, 0, 121, 0);
			OLED_P6x8Int(64, 1, 12, 0);
			OLED_P6x8Int(64, 2, 1, 0);
			OLED_P6x8Int(64, 3, -1, 0);
			OLED_P6x8Int(64, 4, 0, 0);
			OLED_P6x8Int(64, 5, -21, 0);
			OLED_P6x8Int(64, 6, -123, 0);
